 ...
 * 4. Each group is pre-processed with `preprocess(group)`.
 ...
 *    d) Currency exchange rate, where applicable, is taken with `rate(txobject)`.
 ...
 *    i) Find the amount of the target in the trade if any `amount(txobject)`.
