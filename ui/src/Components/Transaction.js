...
export default inject('store')(observer(class Transaction extends Component {
  ...
  render() {
    ...
    return (
      <tr className="Transaction" onClick={onClick}>
        ...
        <td className="description">
          {this.props.tx.description}
          {this.state.open ? (
            <TransactionDetails type="description" current={this.props.tx.account_id} entries={this.props.tx.entries} />
          ) : ''}
        </td>
        <td className="debit">
          &nbsp;{this.props.tx.debit ? money : ''}
          {this.state.open ? (
            <TransactionDetails type="debit" current={this.props.tx.account_id} entries={this.props.tx.entries} />
          ) : ''}
        </td>
        <td className="credit">
          &nbsp;{this.props.tx.debit ? '' : money}
          {this.state.open ? (
            <TransactionDetails type="credit" current={this.props.tx.account_id} entries={this.props.tx.entries} />
          ) : ''}
        </td>
