      ...
      <div className="App">
        ...
        <div className="Page">
          ...
          <div className="MainArea">
            ...
            <div className={`Version ${this.props.store.token ? 'logged-in' : 'not-logged-in'}`} style={{ color: 'rgb(0,0,0,0.5)', fontSize: '0.6rem', position: 'absolute', right: '2px', bottom: '2px' }}>v{Configuration.VERSION}</div>
          </div>
        </div>
      </div>
    )
